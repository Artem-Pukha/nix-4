...
public class InverterFromMilliseconds {
    ...
    static public double toSeconds(long milliseconds) { return format(SECOND * milliseconds); }
    static public double toMinutes(long milliseconds) { return format(MINUTE * milliseconds); }
    static public double toHours(long milliseconds) { return HOUR * milliseconds; }
    static public double toDays(long milliseconds) { return format(DAY * milliseconds); }
    ...
    static public double toCentury(long milliseconds) { return toYears(milliseconds) / 100; }
