...
public class AppDateToString {
    
    public String changeAvailableFormattedDate(String date){
        String changedDate = "";
        int slashCounter = 0;
        int hyphenCounter = 0;
    ...
    private String stringWithSlash(String date){
    ...
    private String stringWithHyphen(String date){
        String[] splittedDate = date.split("[- ]");
